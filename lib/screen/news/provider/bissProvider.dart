...
class BisnessPro extends ChangeNotifier {
  ...
  Future<NewsModal> Apifactory(String data) async {
    String newslike = "https://newsapi.org/v2/top-headlines?country=$data&category=business&apiKey=0bb4fd579918484bb3f75871c88a6f52";
