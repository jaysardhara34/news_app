...
class EnterSecond extends StatefulWidget {
  const EnterSecond({Key? key}) : super(key: key);

  @override
  State<EnterSecond> createState() => _EnterSecondState();
}

class _EnterSecondState extends State<EnterSecond> {
  EnterProvider? apiproviderT;
  EnterProvider? apiproviderF;

  @override
  Widget build(BuildContext context) {
    apiproviderF = Provider.of<EnterProvider>(context, listen: false);
    apiproviderT = Provider.of<EnterProvider>(context, listen: true);
    return SafeArea(
        child: Scaffold(
