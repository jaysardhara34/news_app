...
class HSec extends StatefulWidget {
  const HSec({Key? key}) : super(key: key);

  @override
  State<HSec> createState() => _HSecState();
}

class _HSecState extends State<HSec> {
  HProvider? apiproviderT;
  HProvider? apiproviderF;

  @override
  Widget build(BuildContext context) {
    apiproviderF = Provider.of<HProvider>(context, listen: false);
    apiproviderT = Provider.of<HProvider>(context, listen: true);
    return SafeArea(
        child: Scaffold(
