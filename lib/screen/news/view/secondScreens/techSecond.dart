...
import 'package:news_app/screen/news/provider/techProvider.dart';
import 'package:provider/provider.dart';
import 'package:share_plus/share_plus.dart';

class TechSecond extends StatefulWidget {
  const TechSecond({Key? key}) : super(key: key);

  @override
  State<TechSecond> createState() => _TechSecondState();
}

class _TechSecondState extends State<TechSecond> {
  TechProvider? apiproviderT;
  TechProvider? apiproviderF;

  @override
  Widget build(BuildContext context) {
    apiproviderF = Provider.of<TechProvider>(context, listen: false);
    apiproviderT = Provider.of<TechProvider>(context, listen: true);
    return SafeArea(
        child: Scaffold(
